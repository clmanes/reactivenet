...
import * as CssLength from "../core/CssLength.res.mjs";
...
let install = (function (read, loadRender, loadDestroy, palette, misuraCss) {
...
function loadRender() {
  ...
  let pending$1 = import("./ChartImpl.res.mjs").then(m => m.render);
  loaded.contents = pending$1;
  return pending$1;
}

function loadDestroy() {
  return import("./ChartImpl.res.mjs").then(m => m.destroy);
}
