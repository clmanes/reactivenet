...
import * as ReactiveRef from "../core/ReactiveRef.res.mjs";
...
let installDirectives = (function (attribute, reactiveKey, parseAttributes, registry) {
...
installDirectives(DirectiveAttributes.attribute, ReactiveRef.reactiveKey, DirectiveAttributes.parse, DirectiveRegistry.all);
