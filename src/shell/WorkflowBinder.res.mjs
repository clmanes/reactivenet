...
import * as WorkflowHost from "./WorkflowHost.res.mjs";
import * as ReactiveStore from "./ReactiveStore.res.mjs";
import * as WorkflowGraph from "../core/WorkflowGraph.res.mjs";
import * as WorkflowTrigger from "../core/WorkflowTrigger.res.mjs";
...
function bind(container, app, labels, locale) {
  binder(container, app, labels, locale);
}
